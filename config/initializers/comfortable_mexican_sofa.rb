...
ComfortableMexicanSofa::AccessControl::AdminAuthentication.username = ENV['USERNAME']
ComfortableMexicanSofa::AccessControl::AdminAuthentication.password = ENV['PASSWORD']
